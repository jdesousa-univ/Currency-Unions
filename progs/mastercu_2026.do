...
/* A do-file to form every pairwise combination of countries with years (from 1948 to 2025)*/
do 1.iso3year_2026.do

/* A do-file to determine which "multinational currency" (e.g. US$, euro, ...) a country is using between 1948 and 2025. */
do 2.currency_2026.do

/* A do-file to determine a bilateral currency union dummy (comcur).*/
do 3.dummycu_2026.do
*
export delimited ..\data\comcur_2026.txt, delimiter(tab) replace
*
